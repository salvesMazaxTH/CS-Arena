...
export default {
  ...
  description() {
    return {
      ...
      pt: `Ficar diante de Sengoku Primordial já é, por si só, um peso imenso. Inimigos com menos de <b>${this.threshold * 100}%</b> do <b>Ataque</b> dele não conseguem reunir coragem para mirá-lo — a ação deles simplesmente falha.`,
    };
  },
